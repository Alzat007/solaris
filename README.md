...
连接后，右上角的**实时手势**会显示姿势、识别置信度与操作提示。画面里的光圈跟随掌心或指尖；命中星球时变为金色，并显示目标名称。先伸出食指瞄准星球，再将拇指与食指捏一下即可进入。“已连接”只代表看到了手，姿势不明确时会另行提示。

| 手势                              | 作用                                                  |
| --------------------------------- | ----------------------------------------------------- |
| 食指瞄准星球 → 拇食指捏一下       | 光圈变金色后进入星球；也可点击底部行星名称            |
| 伸出三指（食指、中指、无名指）    | 查看 / 收起当前星球资料                               |
| 比出 ✌，保持片刻                 | 从星球、坍缩或太阳内部返回太阳系                      |
| 手向左 / 向右滑动                 | 聚焦星球时切换相邻行星                                |
| 双手各自拇食指捏合，再拉开 / 靠近 | 太阳系 / 星球视角中，拉开变大、靠近变小；松开结束缩放 |
| 双手张开五指，向中心合拢          | 让星系向中心坍缩                                      |
| 双手快速张掌拉开                  | 进入太阳内部，四周充满流动的金色粒子                  |

双手操作时，让两只手完整留在镜头内。**双手捏合**用于缩放；**双手张掌合拢 / 快速拉开**用于坍缩和进入太阳，避免不同动作互相触发。做完动作稍停一下，再开始下一个动作。太阳内部四周有金色粒子环绕，可以用 ✌ 返回太阳系，或双手合拢再次坍缩。

手势经过短暂稳定确认，捏合有双阈值滞回，滑动有冷却时间。指向目标会短暂锁定，防止捏合过程中指尖移动造成误选。主场景以连续的手部位置、速度、开放程度和捏合强度驱动 GPU 物理场。

也可以直接把捏合光标移到星球上。一次捏合只选择一次，松开后才能再次选择。命中范围跟随星球画面尺寸，并为自然手部抖动留有余量。

**鼠标与键盘：**移动扰动粒子，点击星球选择，在太阳系 / 星球视角中滚轮缩放，`← / →` 切换，`Space` 坍缩 / 进入太阳内部，`S` 直接进入太阳内部，`Esc` 返回，`I` 资料。底部「太阳内部」按钮也可以直接体验环绕粒子。右下角 `?` 可打开完整说明。**触屏：**在太阳系 / 星球视角中单指拖动旋转，点按行星聚焦，双指缩放。默认静音，右上角声音按钮主动开启后才创建音频上下文。
...
双手动作的识别依赖光照、手掌可见程度及检测稳定性。普通电脑浏览器、模型加载、拒绝权限和触屏布局已进行自动化检查；真实双手准确率及 iPhone Safari / Android Chrome 的实际设备帧率仍需现场验证。
